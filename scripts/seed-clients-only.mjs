...
async function seedClientsOnly() {
  try {
    ...
    console.log('👥 Adding real business clients...');
    ...
    console.log(`✅ ${clients.length} real business clients added successfully!`);
    
    console.log('\n🏢 Clients Added:');
    clients.forEach(client => {
      console.log(`   - ${client.companyName} (${client.businessType})`);
    });
    ...
    console.log('   ❌ No airports (will be added next)');
    console.log('\n🚀 Next: Adding airports for route selection');
...
seedClientsOnly().catch(console.error);
